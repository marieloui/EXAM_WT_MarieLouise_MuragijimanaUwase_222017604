...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO messages (therapist_id, client_id, message_content) VALUES (?,  ?, ?)");
    ...
    // Bind parameters
    $stmt->bind_param("sss", $therapist_id, $client_id,  $m_c);
...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['search'])) {
    ...
    $sql_select .= " WHERE  therapist_id LIKE '%$search%' OR client_id LIKE  '%$search%' OR message_content LIKE '%$search%' ";
}
...
<label class="logo" >otp <br>
    ...
    <div class="container">
        ...
        ?>
        <a href="messages.html" class="btn btn-success">Add New</a>
    </div>
    <br>
    ...
    <table id="dataTable" class="table table-hover text-center">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                echo "<a href='messagesupdate.php?updatemessage_content=" . $row['message_content'] . "'><i class='fas fa-edit'></i></a>";
                echo "<a href='messagestdelete.php?message_content=" . $row['message_content'] . "'><i class='fas fa-trash'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
